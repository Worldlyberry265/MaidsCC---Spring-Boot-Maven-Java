...
//	
	...
	//parsing involves breaking down the token into its three parts: header, payload (claims), and signature.
	//It gets the key used to generate the jwt
	//It then apply the  cryptographic algorithm with the SignKey and check if it matches the signature
	}
